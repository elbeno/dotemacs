...
;; set a marker at column 80 and 100
...
;; para-fill properly with doxygen comments
...
#+begin_src emacs-lisp
(load-file "/home/bdeane/dev/cedet/cedet-devel-load.el")
(add-to-list 'load-path "/home/bdeane/dev/cedet/contrib/")
(add-to-list 'Info-directory-list "/home/bdeane/dev/cedet/doc/info")
