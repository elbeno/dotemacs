...
** Frame
#+begin_src emacs-lisp
(setq default-frame-height (/ (display-pixel-height) (frame-char-height)))
(setq frame-left-coord (- primary-monitor-width
                          (/ primary-monitor-width (frame-char-width))))
(setq frame-title-format "%b [emacs]")
(setq default-frame-alist
  `((top . 2)
    (left . ,frame-left-coord)
...
(global-set-key "\C-c2" 'setup-doublewide-layout-keep-split)
#+end_src
* Start server
#+begin_src emacs-lisp
(require 'server)
